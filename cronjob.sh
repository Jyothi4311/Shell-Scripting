...
USAGE(){
    #echo -e "$R USAGE:: $N sh cronjob.sh <SOURCE_DIR> <DEST_DIR> <DAYS(Optional)>"
    echo -e "$R ERROR:: Please provide details as detailed $N backup <SOURCE_DIR> <DEST_DIR> <DAYS(Optional)>"
    exit 1
}
